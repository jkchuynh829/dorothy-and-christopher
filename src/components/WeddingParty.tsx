...
const Inner = tw.div`mt-52 text-center max-w-2xl px-6 w-full`;
const ColumnContainer = tw.div`flex flex-row w-full gap-6 w-full sm:flex-col`;
const Column = tw.div`flex-grow w-full`;
      ...
      <Inner>
        ...
        <ColumnContainer>
          <Column>
            ...
            <Section>
              <SectionHeading>
                <Aerotis>brides parents</Aerotis>
              </SectionHeading>
